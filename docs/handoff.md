...
- [ ] Visual Inspection: Can a tester identify every pinout and sensor orientation on the physical PCBA/Breadboard using only the diagrams provided in this branch?
...
- [ ] Compiler Parity: When the user runs make or the build script, does the resulting binary match the expected size and checksum provided in the release notes of this branch?
...
- [ ] Troubleshooting Logic: Can tester troubleshoot all the project level bugs documented in bug_receipt.md with its own guidance?
