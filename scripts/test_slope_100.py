"""
Slope walker — 100 steps, Renode simulation.
Validates snapshot cadence fix and SI accuracy.
"""
...
if snaps:
    ...
    print(f"Final snapshot SI_stance: {last.si_stance_pct:.1f}%  "
          f"(target <3%)  {'PASS' if si_ok else 'FAIL'}")
